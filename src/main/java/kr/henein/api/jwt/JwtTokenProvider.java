...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token){
        try {
            ...
            throw new kr.henein.api.error.exception.JwtException(ErrorCode.INVALID_TOKEN.getMessage(), ErrorCode.INVALID_TOKEN);
        } catch (ExpiredJwtException e) {
            throw new kr.henein.api.error.exception.JwtException(ErrorCode.EXPIRED_AT.getMessage(), ErrorCode.EXPIRED_AT);
        } catch (UnsupportedJwtException e) {
            throw new kr.henein.api.error.exception.JwtException(ErrorCode.INVALID_TOKEN.getMessage(), ErrorCode.INVALID_TOKEN);
        } catch (IllegalArgumentException e) {
            throw new kr.henein.api.error.exception.JwtException(ErrorCode.EMPTY_TOKEN.getMessage(), ErrorCode.EMPTY_TOKEN);
